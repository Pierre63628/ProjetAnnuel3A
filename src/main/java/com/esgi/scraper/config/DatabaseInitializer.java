...
public class DatabaseInitializer {
    ...
    public static void initialize() {
        try {
            ...
            log.debug("Base de données et schéma initialisés avec succès.");
    ...
    private static void createDatabase() throws SQLException {
        try (Connection conn = DriverManager.getConnection(POSTGRES_URL, USER, PASSWORD);
            ...
            log.debug("Base de données '" + DB_NAME + "' créée avec succès.");
        }
    }
    ...
    private static void createSchema() throws SQLException {
        try (Connection conn = DriverManager.getConnection(DB_URL, USER, PASSWORD);
            ...
            log.debug("Schéma '" + SCHEMA_NAME + "' créé avec succès.");
        }
    }
}
