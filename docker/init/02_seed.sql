...
-- Utilisateurs
INSERT INTO Utilisateur (nom, prenom, email, adresse, date_naissance, telephone, quartier_id)
VALUES 
  ('Dupont', 'Jean', 'jean@example.com', '10 rue de Rivoli', '1990-04-15', '0601020304', 1),
  ('Yuri', 'Claire', 'claire@example.com', '3 avenue Junot', '1985-06-20', '0605060708', 2);
